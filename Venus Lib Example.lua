...
local togglepicker1 = toggle:ColorPicker{
    Default = color(1, 0, 0, 1), -- Red color (RGB normalized 0-1)
...
--togglepicker1:Set(color(1, 1, 1, 1))

local togglepicker2 = toggle:ColorPicker{
    Default = color(0, 1, 0, 1), -- Green color
...
--togglepicker2:Set(color(1, 1, 1, 1))
...
toggle2:Keybind{
    --Default = 0x41, -- A key (VK code)
    --Blacklist = {0x01}, -- MOUSE1
...
--colorpicker:Set(color(1, 1, 1, 1))

local colorpickerpicker1 = colorpicker:ColorPicker{
    Default = color(0, 1, 1, 1), -- Cyan color
    DefaultAlpha = 0.5,
...
--colorpickerpicker1:Set(color(1, 1, 1, 1))

local colorpickerpicker2 = colorpicker:ColorPicker{
    Default = color(1, 1, 1, 1), -- White color
...
--colorpickerpicker2:Set(color(1, 1, 1, 1))

local keybind = section:Keybind{
    Name = "Keybind",
    --Default = 0x41, -- A key
    --Blacklist = {0x01, 0x02}, -- MOUSE1, MOUSE2
    Flag = "Keybind 1",
    Callback = function(key, fromsetting)
        if fromsetting then
...
keybindsection:Keybind{
    Name = "UI Toggle",
    Flag = "UI Toggle",
    Default = 0x2D, -- INSERT key
    --Blacklist = {0x01, 0x02, 0x04}, -- MOUSE1, MOUSE2, MOUSE3
